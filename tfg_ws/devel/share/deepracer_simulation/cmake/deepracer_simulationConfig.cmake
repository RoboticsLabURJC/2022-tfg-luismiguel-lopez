...
if("TRUE" STREQUAL "TRUE")
  set(deepracer_simulation_SOURCE_PREFIX /home/chuismi/Desktop/robotica/cuarto/tfg/2022-tfg-luismiguel-lopez/tfg_ws/src/deepracer_simulation)
  set(deepracer_simulation_DEVEL_PREFIX /home/chuismi/Desktop/robotica/cuarto/tfg/2022-tfg-luismiguel-lopez/tfg_ws/devel)
  ...
  set(deepracer_simulation_INSTALL_PREFIX /home/chuismi/Desktop/robotica/cuarto/tfg/2022-tfg-luismiguel-lopez/tfg_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'deepracer_simulation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chuismi/Desktop/robotica/cuarto/tfg/2022-tfg-luismiguel-lopez/tfg_ws/src/deepracer_simulation/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(deepracer_simulation_EXPORTED_TARGETS ${${deepracer_simulation_dep}_EXPORTED_TARGETS})
endforeach()
